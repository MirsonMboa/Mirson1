<?php
$base_url = 'http://localhost/mirson/examples/';
?>

<!DOCTYPE html>
<html lang="en">
<head>
	<base href="http://localhost/mirson/examples/">
								...
								<li>
									<div class="user-box">
										...
										<div class="u-text">
											...
											<p class="text-muted">monstamboa@gmail.com</p><a href="profile.html" class="btn btn-rounded btn-danger btn-sm">View Profile</a>
										</div>
									</div>
								</li>
								<li>
